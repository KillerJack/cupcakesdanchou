...
$stmt = $pdo->prepare('SELECT * FROM produtos ORDER BY date_added DESC LIMIT ?,?');
...
<div class="products content-wrapper">
    ...
    <div class="products-wrapper">
        ...
        <a href="index.php?page=product&id=<?=$product['id']?>" class="product">
            <img src="<?=$product['imagem_url']?>" width="200" height="200" alt="<?=$product['nome_produto']?>">
    ...
    <div class="buttons">
        ...
        <a href="index.php?page=products&p=<?=$current_page+1?>">Próximo</a>
        <?php endif; ?>
    </div>
</div>
